...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\wamp64\www\newwwwwwwwwwwwexemple\Projet_Fil_Rouge\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\wamp64\\www\\newwwwwwwwwwwwexemple\\Projet_Fil_Rouge\\public\\storage','inertia.ssr.enabled','inertia.ssr.url',
...
'verification.send','password.confirm','logout','about',
'faq','history','reservation.agency','reservation.trip','reservation.plan',
'reservation.details','reservation.payment','reservation.processPayment','reservation.confirmation','admin.agencies.store',
'admin.trips.store','admin.agencies.create','storage.local',);
